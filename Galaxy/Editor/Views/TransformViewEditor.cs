...
public class TransformViewEditor : Editor
{
    ...
    private void DrawSynchronizePositionData()
    {
        ...
        Rect rect = EditGUI.ContainerBody(containerHeight);
    ...
    {
        return EditGUI.RichLabel.CalcHeight(new GUIContent(INTERPOLATE_HELP), Screen.width - 54) + 35;
    }

    private float GetExtrapolateHelpBoxHeight()
    {
        return EditGUI.RichLabel.CalcHeight(new GUIContent(EXTRAPOLATE_HELP), Screen.width - 54) + 35;
    }
    ...
    private void DrawHelpBox(ref Rect propertyRect, bool isOpen, float height, string helpText, string url)
    {
        if (isOpen == true)
        {
            ...
            GUI.Label(new Rect(5, 5, propertyRect.width - 10, height - 30), helpText, EditGUI.RichLabel);
    ...
    private void DrawPropertyWithHelpIcon(ref Rect propertyRect, ref bool isHelpOpen, SerializedProperty property, string tooltip)
    {
        ...
        //isHelpOpen = GUI.Toggle(helpIconRect, isHelpOpen, EditGUI.HelpIcon, GUIStyle.none);
    ...
    private void DrawHeader(string label, SerializedProperty property)
    {
        ...
        bool newValue = EditGUI.ContainerHeaderToggle(label, property.boolValue);
