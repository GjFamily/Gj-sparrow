...
namespace socket.io {
    ...
    public class Socket : MonoBehaviour {
		...
		public void Disconnect() {
			...
			var pkt = new Packet(EnginePacketTypes.MESSAGE, SocketPacketTypes.DISCONNECT, Namespace, string.Empty);
		...
		public void DisconnectAll() {
			if(WebSocketTrigger != null && WebSocketTrigger.WebSocket != null && WebSocketTrigger.WebSocket.IsConnected)
        ...
        public bool IsConnected {
            get {
                return (!IsDisconnect && WebSocketTrigger != null &&
		...
		protected bool IsDisconnect { get; set; }
        ...
        void DispatchPacket(Packet pkt) {
            ...
            switch (pkt.socketPktType) {
				...
				case SocketPacketTypes.DISCONNECT:
					OnDisconnect();
					break;
